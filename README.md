...
Media Backup Client `0.4.13` 是 Media Backup 的 Android 与 iOS 应用。它读取用户授权的照片和视频，在本地维护上传队列，通过 HTTPS 备份到独立的 [Media Backup Server](https://github.com/isarmg/media-backup-server)，并提供本地图库与云端图库。
