...
final class NavigationTests: XCTestCase {
    @MainActor func testLoginRemainsReachableFromGalleryAndSettings() {
        ...
        let visibility = app.buttons["pairing.authorization-code-visibility"]
        visibility.tap()
        XCTAssertEqual(app.textFields["pairing.authorization-code"].value as? String, "test-instance-code")
        visibility.tap()
        XCTAssertTrue(app.secureTextFields["pairing.authorization-code"].exists)
