...
final class MobileContractV02Tests: XCTestCase {
    func testCurrentContractUsesDeclaredSandboxPaths() throws {
        ...
        XCTAssertEqual(currentDatabase.lastPathComponent, "client-v0.4-r1.sqlite")
        XCTAssertEqual(currentStaging.lastPathComponent, "backup-staging-v0.4-r1")
    ...
    func testCredentialAndPreferenceDomainsAreV02Only() {
        ...
        XCTAssertEqual(MobileContractV02.applicationVersion, "0.4.0")
        ...
        XCTAssertTrue(MobileContractV02.tokenKey.contains("v0_4_r1"))
    }
