...
正式发行版本检查还要求已存在、指向 HEAD 的发行标签以及干净 checkout；本次工作是未提交源码变更，未执行发行。

当前 Linux 工作区没有 Xcode、Apple SDK 和手机，因此不能声明已完成 iOS 构建、系统后台调度、
实机触控或视频解码兼容性验收。人脸识别、AI 分类、共享相册与复杂编辑不在本次范围。
